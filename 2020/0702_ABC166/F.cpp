...
int main()
{
  ...
  if (s == 1)
  {
    for (auto i{0}; i < n; ++i)
    {
      auto execute = [&](ll &x, ll &y, string const &p, string const &q) {
        if (x == 0 && y == 0)
        {
          No();
        }
  ...
  else
  {
    for (auto i{0}; i < n; ++i)
    {
      auto execute2 = [&](ll &x, ll &y, string const &p, string const &q, bool is_x) {
        if (x == 0 && y == 0)
        {
          No();
        }
      ...
      if (v[i] == "AB")
      {
        bool is_x{i == n - 1 || v[i + 1] == v[i] || v[i + 1] == "AC"};
        execute2(a, b, "A", "B", is_x);
      }
      else if (v[i] == "BC")
      {
        bool is_x{i == n - 1 || v[i + 1] == v[i] || v[i + 1] == "AB"};
        execute2(b, c, "B", "C", is_x);
      }
      else
      {
        bool is_x{i == n - 1 || v[i + 1] == v[i] || v[i + 1] == "BC"};
        execute2(c, a, "C", "A", is_x);
      }
    }
  }
  cout << "Yes" << endl;
