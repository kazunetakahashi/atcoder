...
int main()
{
  ...
  for (auto i = 1; i < N; i++)
  {
    if (S[i] == 'X')
    {
      for (auto k = 0; k < 2; k++)
      {
        DP[i][0][1][0] = DP[i][0][1][0] + int_1(DP[i - 1][1][1][k]);
      }
      for (auto k = 0; k < 2; k++)
      {
        for (auto l = 0; l < 2; l++)
        {
          DP[i][0][1][0] = DP[i][0][1][0] + int_0(DP[i - 1][k][l][1]);
        }
      }
    }
    else
    {
      for (auto k = 0; k < 2; k++)
      {
        DP[i][0][0][1] = DP[i][0][0][1] + int_1(DP[i - 1][1][1][k]);
      }
      for (auto k = 0; k < 2; k++)
      {
        DP[i][1][1][1] = DP[i][1][1][1] + int_1(DP[i - 1][0][1][k]);
      }
      for (auto k = 0; k < 2; k++)
      {
        for (auto l = 0; l < 2; l++)
        {
          DP[i][0][0][1] = DP[i][0][0][1] + int_0(DP[i - 1][k][l][1]);
        }
      }
    }
  }
